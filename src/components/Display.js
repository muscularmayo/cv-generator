...
//   const personalInformation = props.data.personalInformation;
//   const educationInformation = props.data.educationInformation;
//   const experienceInformation = props.data.experienceInformation;
...
//     return (
//       <div className="experience-dispaly" key={'experience' + index}>
...
export default function Display (props) {
  const personalInformation = props.data.personalInformation
  const educationInformation = props.data.education;
  const experienceInformation = props.data.experience;
